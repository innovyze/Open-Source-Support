...
Originally generated by AI **Last Updated:** March 19, 2026
...
- `InfoWorks_ICM_SQL_Syntax_Reference.md` - Quick reference field name tables
...
**Use order:**
1. Check `InfoWorks_ICM_SQL_Schema_InfoWorks.md` or `InfoWorks_ICM_SQL_Schema_SWMM.md` first for an exact field match
2. If the field is not listed there, use this guide to locate it in Autodesk Help
...
Examples:
- Search for: `Conduit Data Fields (InfoWorks)` → InfoWorks Conduit
- Search for: `Conduit Data Fields (SWMM)` → SWMM Conduit  
- Search for: `Node Data Fields (InfoWorks)` → InfoWorks Node
...
2. Search Help for: `Conduit Data Fields (InfoWorks)`
...
| Imperviousness | `runoff_index` | `percent_impervious` |
