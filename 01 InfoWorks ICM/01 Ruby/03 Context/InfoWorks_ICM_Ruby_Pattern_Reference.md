...
## Document Purpose
This is a **pattern reference guide** for LLM-assisted Ruby scripting in InfoWorks ICM. For tutorial-style learning and complete examples, see `InfoWorks_ICM_Ruby_Tutorial_Context.md`.
...
**For Learning & Complete Examples:** Refer to `InfoWorks_ICM_Ruby_Tutorial_Context.md`
