...
This is a **tutorial-style context guide** for learning InfoWorks ICM Ruby scripting. For concise pattern references and quick lookups, see `InfoWorks_ICM_Ruby_Pattern_Reference.md`.
...
### **When to Use This vs Pattern Reference**
- **Use This Tutorial Context**: When learning Ruby scripting, understanding concepts, or generating complete scripts
- **Use Pattern Reference**: When you need quick pattern lookup, specific pattern IDs, or composing complex scripts from patterns
...
- `hw_1d_results_point` - 1D results points
- `hw_2d_point` - 2D mesh points
- `hw_runoff_surface` - Runoff surfaces
- `hw_land_use` - Land use definitions
- `hw_ground_infiltration` - Ground infiltration parameters
- `hw_rtc` - Real Time Control objects
