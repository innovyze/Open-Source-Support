...
def import_pipe_hydraulics(cn)
  val=WSApplication.prompt "Pipe Hydraulics for this InfoSewer Scenario",
  [
  ['Pick the Folder with InfoSewer Dataset','String',nil,nil,'FOLDER','Pipe Folder'],
  ['The pipehyd.csv file will be read', 'String']
  ],false
