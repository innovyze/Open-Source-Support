...
def import_node_loads(open_net)    
  ...
  val=WSApplication.prompt "Manhole Loadings for this InfoSewer Scenario",
  [
  ['Pick the Folder with InfoSewer Dataset','String',nil,nil,'FOLDER','Manhole Folder'],
  ['The mhhyd.csv file will be read', 'String']
  ],false
