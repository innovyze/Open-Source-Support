...
cn.each_selected do |sel|
  puts "Selected object: #{sel.id}"
  begin
    # Try to get the row object for the current link
    ro = cn.row_object('sw_conduit', sel.id) 
