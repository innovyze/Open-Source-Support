...
Exchange scripts will sometimes be packaged alongside an `exchange.bat` file. This is precursor command that triggers the script. It uses a specific version of the Workgroup Client that can be customisable (see example below).
```bat
@ECHO OFF
SET version=2021.1
SET bit=64
